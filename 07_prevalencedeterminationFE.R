...
#Model1 is a recreation of the 'FERG' model which runs a hierarchical mixed-effects model with SYNDROME/AGERANGE/SITE_RV_VAX/MIDPOINT/URBAN as fixed effects with SITE_ID/EST_ED as a random effect. 
